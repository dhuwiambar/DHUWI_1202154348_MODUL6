...
public class AdpPost extends RecyclerView.Adapter<AdpPost.PostViewHolder>{
        private List<dBPost> list;
        private Context con;

        public AdpPost(List<dBPost> list, Context con){
            this.list = list;
            this.con = con;
        }
        ...
        public void onBindViewHolder(PostViewHolder holder, int position) {
            ...
            Glide.with(con).load(current.getImage()).placeholder(R.drawable.pisang).override(450, 450).into(holder.image);
